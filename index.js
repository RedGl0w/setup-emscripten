...
async function run() {
  try {
    ...
    await exec.exec('ls -la emsdk/')
    await exec.exec('ls -la emsdk/emscripten')
    await exec.exec('ls -la emsdk/emscripten/latest')
    await exec.exec('ls -la emsdk/emscripten/latest/x64')
